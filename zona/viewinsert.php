...
<html>
    ...
    <body>
        ...
        <div id="cont"><br />
       <h1 class="titulo">Insertar una nuevo zona al ZOO!</h1>
        <form action="phpinsert.php" method="POST">
            ID Zona<sup>*</sup> <input required  type="text" name="IDZona" value="" /><br /><br />
            Nombre Zona<sup>*</sup> <input required  type="text" name="NombreZona" value="" /><br /><br />
            Tipo<sup>*</sup><input required  list="tipos" name="Tipo" value="" /><br /><br />
            <datalist id="tipos">
                <option value="Agua" />
                <option value="Aire" />
                <option value="Selva" />
